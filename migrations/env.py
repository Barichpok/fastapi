...
# add current path to PYTHONPATH, otherwise models module will not be found when alembic executing
...
# target_metadata = [Base.metadata, User.metadata, Token.metadata]
